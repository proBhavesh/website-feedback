...
const Header = () => {
	return (
		<>
			<div className="pt-16 px-4 bg-lightBlue mx-auto h-screen font-sans text-center md:text-left">
				<div className="grid grid-rows-2 m-auto md:grid-cols-2 max-w-6xl  pt-24 gap-8">
